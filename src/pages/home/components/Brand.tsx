  ...
  return (
    <div className="w-full">
      <div className="p-3.5 bg-[#222] flex justify-center font-bold text-sm items-center">
        ...
        <span className="inline-block ml-2.5 text-primary font-sans">513.343 Lorem</span>
      </div>
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-black/50 flex justify-center items-center flex-col">
          <div className="text-white font-sans font-bold text-xl mb-3.5">400 Lorem Ipsum Lorem Ipsum</div>
          <div
            className="justify-center flex mb-[22px] gap-4"
          >
