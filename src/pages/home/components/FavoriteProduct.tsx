...
import { CHECK_END, CHECK_START, PATH_PRODUCT_DETAIL } from "constant";
...
export default function HomeFavoriteProduct(props: IProps) {
  //page props
  ...
  return (
    <Link href={PATH_PRODUCT_DETAIL} passHref>
      <div className="mt-4 bg-white py-4 cursor-pointer">
        {title && (
          <>
            <div className="title ml-4 mb-3">{t("home.favoriteProduct")} </div>
            <div className="title-desc mb-4 text-center">
              {t("home.productDesc")}
            </div>
          </>
        )}
